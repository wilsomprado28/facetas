...
<body>
    ...
    <section class="contact spad">
        ...
        if($sucesso){
            echo "<p style='width:100%; float:left; text-align:center;'>Paciente cadastrado com sussesso. vamos cadastrar outro?</p>";
        }
    ?>
                            <form action="./back/cadastro.php" method="POST">
                                ...
                                <input type="text" name="forma"     placeholder="WE Forma">
                                <input type="text" name="palfique"  placeholder="BW Palfique">
                                <input type="text" name="adesivo"   placeholder="Adesivo">
                                <input type="text" name="ajustes"   placeholder="Ajustes">
